...
import { addStreamingSchema } from "../../../../../Services/Validations/Admin";
...
const Update = () => {
  ...
  const submitHandler = (values) => {
    ...
    headersPost(admin_api_routes?.create_streaming, formData)
      .then((res) => {
        if (res?.status === 200) {
  ...
  return (
    <Fragment>
      <Box>
        <Box margin={1}>
          <Typography variant={"h4"}>Add Streaming Channel</Typography>
        </Box>

        <Formik
          initialValues={initialValues}
          onSubmit={submitHandler}
          validationSchema={addStreamingSchema}
        >
          {({
            values,
            handleChange,
              ...
              <Grid container>
                ...
                >
                  <TextField
                    ...
                    name="description"
                    onChange={handleChange}
                    placeholder="Enter your Streaming Channel description"
                ...
                >
                  <TextField
                    variant="outlined"
                    type="text"
                    label="Select Streaming Channel Category"
                    fullWidth
                ...
                >
                  <TextField
                    ...
                    placeholder="Select Streaming Channel image"
                ...
                >
                  <FormGroup row>
                    <FormControlLabel
                      ...
                      label="Is this Streaming Channel default?"
                    />
                  </FormGroup>
                </Grid>
                <Grid
                ...
                >
                  <FormGroup row>
                    <FormControlLabel
                      ...
                      label="Is this Streaming Channel featured?"
                    />
                  </FormGroup>
                </Grid>
                <Grid
